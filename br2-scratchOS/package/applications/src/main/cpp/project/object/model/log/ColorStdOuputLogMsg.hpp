...
#ifndef PROJECT_OBJECT_MODEL_LOG_COLORSTDOUPUTLOGMSG_HPP
#define PROJECT_OBJECT_MODEL_LOG_COLORSTDOUPUTLOGMSG_HPP
#include <sstream>
#include <iomanip>
...
class ColorStdOuputLogMsg
    : public log4cxx::helpers::DateLayout
{
enum
{
    Black,
