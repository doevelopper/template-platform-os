...
log4cxx::LoggerPtr ExecutionContext::logger =
    log4cxx::Logger::getLogger(std::string("project.object.model.launcher.ExecutionContext"));

log4cxx::LoggerPtr ExecutionContext::QueuedHandleBase::logger =
    log4cxx::Logger::getLogger(std::string("project.object.model.launcher.ExecutionContext.QueuedHandleBase"));

template <typename F>
log4cxx::LoggerPtr ExecutionContext::QueuedHandler<F>::logger =
    log4cxx::Logger::getLogger(std::string("project.object.model.launcher.ExecutionContext.QueuedHandler"));

log4cxx::LoggerPtr ExecutionContext::Executor::logger =
    log4cxx::Logger::getLogger(std::string("project.object.model.launcher.ExecutionContext.Executor"));
/*
