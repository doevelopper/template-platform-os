...
#ifndef PROJECT_OBJECT_MODEL_LAUNCHER_METHOD_HPP
#define PROJECT_OBJECT_MODEL_LAUNCHER_METHOD_HPP

#include <project/object/model/launcher/MethodCaller.hpp>
...
namespace project::object::model::launcher
{
    ...
    class  Method final
        : public MethodCaller<FunctionSig,DispatchPolicy>
    {
