...
#include <typeinfo>
#include <filesystem>
#include <project/object/model/log/LoggingServicePrivate.hpp>
...
/*
   log4cxx::LoggerPtr LoggingServicePrivate::getLoggerByName (const char * loggerName)
   {
    LOG4CXX_TRACE(log4cxx::Logger::getRootLogger(), __LOG4CXX_FUNC__);
   log4cxx::LogString
...
// https://logging.apache.org/log4j/2.x/manual/layouts.html
        ...
        log4cxx::PatternLayoutPtr layout (new log4cxx::PatternLayout (
                LOG4CXX_STR("%d{HH:mm:ss.SSS} [%-6p] - [%15.15t] - %-32c{1.} -- %m%n")));
