...
#ifndef PROJECT_OBJECT_MODEL_LAUNCHER_CHANEL_HPP
#define PROJECT_OBJECT_MODEL_LAUNCHER_CHANEL_HPP
...
namespace project::object::model::launcher
{
    ...
    public:
        ...
        auto set_dispatcher(const DispatchPolicy& policy ) -> std::enable_if_t<std::is_copy_constructible<DispatchPolicy>::value,
                                                                               void>
        {
            LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__ );
